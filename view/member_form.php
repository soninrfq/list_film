              ...
              <div class="card-body">
                <form action="membersController.php" method="post">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="password" id="password" class="form-control" placeholder="SHA1(MD5(password))">
                  </div>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="role" id="role" class="form-control" placeholder="'admin', 'manager', 'penonton'">
                  </div>
