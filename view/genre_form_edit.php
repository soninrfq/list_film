            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                <form action="genreController.php" method="post">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Genre</label>
                        <div class="input-group-prepend">
                        <span class="input-group-text">@</span>
                        </div>
                    <input type="text" name="nama" id="nama" class="form-control" placeholder="<?php echo $data['nama'] ?>">
                    </div>
                    ...
                    <input type="text" name="keterangan" id="keterangan" class="form-control" placeholder="<?php echo $data['keterangan'] ?>">
                    </div>
